      ...
      < header id="home" >
        ...
        <div className="row banner">
          <div className="banner-text">
            ...
            <h3>I'm a {city} based <span>{occupation}</span>. {description}. Let's <a className="smoothscroll" href="#about">start scrolling</a> and learn more <a className="smoothscroll" href="#about">about me</a>.</h3>
            <hr />
            <ul className="social">
              {networks}
            </ul>
